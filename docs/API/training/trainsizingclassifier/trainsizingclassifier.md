...
<a href="https://github.com/tvdboom/ATOM/blob/master/atom/training.py#L384">[source]</a>
</span>
</div>
...
<strong>train_sizes: int or sequence, default=5</strong><br>
...
<td width="80%" class="td_params">
<p>
<strong>other: TrainSizingClassifier</strong><br>
...
<td width="20%" class="td_title" style="vertical-align:top"><strong>Returns:</strong></td>
<td width="80%" class="td_params">
<strong>TrainSizingClassifier</strong><br>
Estimator instance.
</td>
</tr>
</table>
...
# Run the pipeline
trainer = TrainSizingClassifier("RF", n_trials=5, n_initial_points=3)
