...
* Refactor of the [distribution][atomclassifier-distribution] method.
...
* The `column` parameter in the [distribution][atomclassifier-distribution]
...
* The [score][adaboost-score] method is now also able to calculate custom metrics on new data.
...
* The [distribution][atomclassifier-distribution] and [plot_distribution][]
...
* Added the `sample_weight` parameter to the [score][adaboost-score] method.
