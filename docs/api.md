...
<pre><em>class</em> atom.<strong style="color:#008AB8">ATOMClassifier</strong>(<em><strong>X</strong>,
                          <strong>y=None,</strong>
                          <strong>percentage=100,</strong>
                          <strong>test_size=0.3,</strong>
                          <strong>log=None,</strong>
                          <strong>n_jobs=1,</strong>
                          <strong>warnings=False,</strong>
                          <strong>verbose=0,</strong>
                          <strong>random_state>=None,</strong>
                          <strong>verbosity=0</strong></em>)</pre>
<div align="right"><a href="https://github.com/tvdboom/ATOM/blob/master/atom/atom.py">[source]</a></div>

Automated machine learning for supervised classification tasks.

!!! note
    Contrary to scikit-learn's API, the ATOMClassifier object contains the dataset
