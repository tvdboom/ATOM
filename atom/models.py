...
def set_init(data, target_mapping, metric, task,
             log, n_jobs, verbose, random_state, scaled=False):
...
class GP(BaseModel):
    ...
    def get_params(self, x):
        return False  # GP has no hyperparameters to optimize
...
class GNB(BaseModel):
    ...
    def get_params(self, x):
        return False  # GNB has no hyperparameters to optimize
...
class OLS(BaseModel):
    ...
    def get_params(self, x):
        return False  # OLS has no hyperparameters to optimize
