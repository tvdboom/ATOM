...
* Support for [Python 3.11](https://www.python.org/downloads/release/python-3110/).
...
* ATOM's pipeline now supports [metadata routing](https://scikit-learn.org/stable/metadata_routing.html).
