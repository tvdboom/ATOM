...
<strong>strategy: str, default="dfs"</strong><br>
...
<p>
<strong>n_features: int or None, default=None</strong><br>
Maximum number of newly generated features to add to the dataset. If
None, select all created features.
</p>
<p>
<strong>operators: str, list, tuple or None, default=None</strong><br>
