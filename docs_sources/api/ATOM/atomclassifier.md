...
<div align="right"><a href="https://github.com/tvdboom/ATOM/blob/master/atom/atom.py#L528">[source]</a></div></pre>
Balance the number of rows per target class in the target column. Only the training
