...
<div align="right"><a href="https://github.com/tvdboom/ATOM/blob/master/atom/training.py#L291">[source]</a></div></pre>
...
Just like `atom`, you can [predict](../../../user_guide/#predicting),
 ...
 from the SuccessiveHalvingClassifier instance. Read more in the [user guide](../../../user_guide/#training).
<br />
<table>
<tr>
...
<blockquote>
Dataframe of the training results with the number of models in a run and the model
...
<tr>
<td><a href="#SuccessiveHalvingClassifier-calibrate">calibrate</a></td>
<td>Calibrate the winning model.</td>
</tr>

<tr>
<td width="15%"><a href="#SuccessiveHalvingClassifier-clear">clear</a></td>
...
<tr>
<td width="15%"><a href="#SuccessiveHalvingClassifier-log">log</a></td>
...
<tr>
<td><a href="#SuccessiveHalvingClassifier-scoring">scoring</a></td>
...
<a name="SuccessiveHalvingClassifier-calibrate"></a>
...
<a name="SuccessiveHalvingClassifier-clear"></a>
...
<a name="SuccessiveHalvingClassifier-log"></a>
...
<div align="right"><a href="https://github.com/tvdboom/ATOM/blob/master/atom/training.py#L97">[source]</a></div></pre>
<div style="padding-left:3%">
...
<blockquote>
Name to save the file with. If None or 'auto', use default name (SuccessiveHalvingClassifier).
</blockquote>
...
<a name="SuccessiveHalvingClassifier-scoring"></a>
