...
<a href="https://github.com/tvdboom/ATOM/blob/master/atom/data_cleaning.py#L268">[source]</a>
</span>
</div>
...
<span style="float:right"><a href="https://github.com/tvdboom/ATOM/blob/master/atom/data_cleaning.py#L333">[source]</a></span></div>
Fit to data.
<table style="font-size:16px">
<tr>
<td width="20%" style="vertical-align:top; background:#F5F5F5;"><strong>Parameters:</strong></td>
...
<span style="float:right"><a href="https://github.com/tvdboom/ATOM/blob/master/atom/data_cleaning.py#L380">[source]</a></span></div>
