...
<a href="https://github.com/tvdboom/ATOM/blob/master/atom/data_cleaning.py#L412">[source]</a>
</span>
</div>
...
<span style="float:right">
<a href="https://github.com/tvdboom/ATOM/blob/master/atom/data_cleaning.py#L505">[source]</a>
</span>
</div>
Apply the data cleaning steps to the data.
<table style="font-size:16px">
