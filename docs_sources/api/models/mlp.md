...
regression, in that between the input and the output layer, there can
be one or more non-linear layers, called hidden layers.
...
<p>
<strong>activation: str, default="relu"</strong><br>
Categorical(["identity", "logistic", "tanh", "relu"], name="activation")
</p>
<p>
<strong>solver: str, default="adam"</strong><br>
...
<p>
<strong>learning_rate_init: float, default=1e-3</strong><br>
...
<p>
<strong>max_iter: int, default=200</strong><br>
...
atom.run(models="MLP", est_params={"solver": "sgd", "activation": "relu"})
```