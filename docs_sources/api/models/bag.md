...
the variance of a black-box estimator (e.g., a [decision tree](../tree)),
...
Read more in sklearn's [documentation](https://scikit-learn.org/stable/modules/ensemble.html#bootstrapping).
...
<p>
<strong>n_estimators: int, default=10</strong><br>
Integer(10, 500, name="n_estimators")
</p>
<p>
<strong>max_samples: float, default=1.0</strong><br>
Categorical(np.linspace(0.5, 1.0, 6), name="max_samples")
</p>
<p>
<strong>max_features: float, default=1.0</strong><br>
Categorical(np.linspace(0.5, 1.0, 6), name="max_features")
</p>
<p>
<strong>bootstrap: bool, default=True</strong><br>
Categorical([True, False], name="bootstrap")
</p>
<p>
<strong>bootstrap_features: bool, default=False</strong><br>
