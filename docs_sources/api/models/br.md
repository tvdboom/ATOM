...
Read more in sklearn's [documentation](https://scikit-learn.org/stable/modules/linear_model.html#bayesian-regression).
...
<p>
<strong>n_iter: float, default=300</strong><br>
...
or `atom.br.predict(X)`. The remaining utility methods can be found hereunder.
...
atom.run(models="BR", n_trials=20, n_initial_points=7, n_bootstrap=5)
```
