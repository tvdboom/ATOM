...
Random forests are an ensemble learning method that operate by constructing a multitude
...
<strong>max_features: str, float or None, default='sqrt'</strong>
<blockquote>
Categorical([None, 'sqrt', 'log2', \*np.linspace(0.5, 0.9, 5)], name='max_features')
</blockquote>
