...
Bernoulli Naive Bayes implements the Naive Bayes algorithm for multivariate Bernoulli
 models. Like [Multinomial Naive bayes (MNB)](../mnb), this classifier is suitable for
...
The majority of the [plots](../../../user_guide/#plots) and [prediction methods](../../../user_guide/#predicting)
 can be called directly from the model, e.g. `atom.bnb.plot_permutation_importance()` or `atom.bnb.predict(X)`.
