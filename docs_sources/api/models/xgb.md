...
XGBoost is an optimized distributed gradient boosting model designed to be highly
 efficient, flexible and portable. XGBoost provides a parallel tree boosting that
...
!!!note
    XGBoost allows [early stopping](../../../user_guide/#early-stopping) to stop
...
You can use the same [data attributes](../../ATOM/atomclassifier#data-attributes)
 as the trainers to check the dataset that was used to fit a particular
